// Service worker for the Bliss Tiles & Puzzles web app (the /tiles/ shell).
// Scope is /tiles/ (this file's folder), so it is independent of the Symbols
// app's worker at /symbols/sw.js — publishing one never disturbs the other.
...
const CACHE_NAME = 'bts-tiles-v18';

// This app's shell, served over HTTP from this origin (GitHub Pages). The shared
// engine + vendored deps live above /tiles/, reached with ../ . The user's
